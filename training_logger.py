...
class TrainingLogger:
    def __init__(self, log_dir='out/'):
        ...
        self.logged = False  # Flag to check if logging has been done
    ...
    def log_training_info(self, task_name, model_name, dataset_name, hyperparams, metrics, start_time, end_time, test_metrics, initial_params, final_params):
        if not self.logged:  # Check if logging has already been done
            ...
            with open(log_file, 'a') as f:
                ...
                f.write("\n" + "-"*50 + "\n")
            self.logged = True  # Set the flag to True after logging
