...
def get_meddef(depth: float, input_channels: int = 3, num_classes: int = None,
               robust_method: Optional[BaseRobustMethod] = None) -> nn.Module:
    depth_to_block_layers = {
        3.0: (CBAMBasicBlock, (2, 2, 2, 2)),  # Depth 18
        3.1: (CBAMBasicBlock, (3, 4, 6, 3)),  # Depth 34
        3.2: (CBAMBottleneckBlock, (3, 4, 6, 3)),  # Depth 50
        3.3: (CBAMBottleneckBlock, (3, 4, 23, 3)),  # Depth 101
        3.4: (CBAMBottleneckBlock, (3, 8, 36, 3)),  # Depth 152
        3.5: MedDef1_5,  # Depth 50 x 2
        3.6: MedDef1_6,  # Depth 18 x 2
    }
